...
No config or setup is needed for Reown integrations.

For other usage, the endpoint is:

```
https://rpc.walletconnect.org/v1?chainId=eip155:1&projectId=<your-project-id>
```
