---
title: WalletGuide API
---

The Cloud WalletGuide API currently offers the following functionality:
...
- [Logos](#logos) - Provides logo assets in different sizes for a given Cloud WalletGuide entry.
...
Returns a JSON object containing all wallets listed in the cloud WalletGuide.
...
Returns a JSON object containing all dApps listed in the public cloud WalletGuide.
...
Returns a JSON object containing all hybrids listed in the public cloud WalletGuide.
...
Returns a JSON object containing all entries listed in the public cloud WalletGuide.
...
| id    | Corresponds to a Cloud WalletGuide entry's `image_id` field as returned by the Listings API |
