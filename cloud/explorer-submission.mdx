...
- Head over to [dashboard.reown.com](https://dashboard.reown.com/) and create a new project by clicking the dropdown in the top right corner, selecting your team name, and then clicking the **"+ Project"** button.
- Give your project a suitable name, select whether it's an App or Wallet, and click the "Add" button. (You can change this later)

  <Frame>
    <img width="400" height="400" src="/images/cloud/create1.png" />
  </Frame>
