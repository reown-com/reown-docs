...
For chains with native Reown AppKit SDK support (EVM, Solana, Bitcoin, and Polkadot), see the [Reown AppKit Supported Chains](/appkit/networks/supported-chains) page.
</Note>
