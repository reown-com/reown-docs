...
<CardGroup cols={2}>
  <Card title="Build a Web3 App in 10 minutes" icon="cubes" href="/appkit/react/core/installation">
    Learn how to build a Web3 app using Reown AppKit in 10 minutes
  </Card>

  <Card title="Make your wallet WalletConnect compatible" icon="wallet" href="/walletkit/android/installation">
    Learn how to make your wallet WalletConnect compatible using Reown WalletKit
  </Card>
</CardGroup>
