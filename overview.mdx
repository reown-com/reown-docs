...
<CardGroup cols={3}>
  ...
  <Card title="Build a Web3 App with AI" icon="robot" href="/appkit/react/core/installation">
    Learn how to build a Web3 app using Reown AppKit with AI
  </Card>

  <Card title="Build a Web3 App using the AppKit CLI" icon="terminal" href="/appkit/cli/installation">
