Reown TON is built on top of the Reown library and provides a set of components and actions to easily connect TON wallets with your decentralized application.
