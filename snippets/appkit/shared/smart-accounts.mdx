...
### How to verify the signature message?

You can verify the signature message using this viem function : [verifyMessage ERC1271 / ERC6492 / ERC8010](https://viem.sh/docs/actions/public/verifyMessage).
