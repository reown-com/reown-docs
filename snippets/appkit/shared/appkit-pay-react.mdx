...
Here you can find a simplified process to integrate Pay:
...
<Card title="Pay Example" icon="github" href="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-wagmi-appkit-pay">
...
<Note>
Projects currently using Reown, or planning to use it to build custom payment flows with self-custodial wallets, should use Pay for a streamlined integration and significantly improved user experience out of the box. Pay can be found in `@reown/appkit-pay` npm package.
</Note>
