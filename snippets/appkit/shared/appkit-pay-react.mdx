...
## Quick Start 
Here you can find a simplify process to integrate AppKit Pay:
...
In order to run the payment, we are using the hook `usePay`. This hook receive two parameter to manage the success or the error in the process.
