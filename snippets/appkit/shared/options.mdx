...
Metadata for your Reown instance. The `name`, `description`, `icons`, and `url` are used at certain places like the wallet connection, sign message, etc screens. If not provided, they will be fetched from the metadata of your website's document object.
...
Enable or disable debug mode in your Reown instance. This is useful if you want to see UI alerts when debugging. Default is `false`.
...
Enable or disable the swap feature in your Reown instance. [Swaps](/appkit/react/transactions/swaps) feature is enabled by default.
...
Enable or disable the onramp feature in your Reown instance. [Onramp](/appkit/react/transactions/onramp) feature is enabled by default.
