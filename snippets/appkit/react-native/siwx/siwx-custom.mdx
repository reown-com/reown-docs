...
All the typings used are exposed by `@reown/appkit-common-react-native` package. You may check the source code [here](https://github.com/reown-com/appkit-react-native/tree/main/packages/common/src/types/siwx).
