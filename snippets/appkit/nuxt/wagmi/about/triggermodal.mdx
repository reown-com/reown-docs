To open Reown you can use our [**web component**](/appkit/nuxt/core/components) or build your own button with Reown [**composables**](/appkit/nuxt/core/composables#useAppKit).
