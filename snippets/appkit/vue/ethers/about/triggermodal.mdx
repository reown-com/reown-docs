To open the modal you can use our [**web component**](/appkit/vue/core/components) or build your own button with the Reown [**composables**](/appkit/vue/core/composables#useAppKit).
