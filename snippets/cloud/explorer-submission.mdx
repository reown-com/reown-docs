...
Submitting a project to the Reown Cloud WalletGuide is recommended but optional. You can still use Reown services without submitting your project.
However, doing so ensures that your project is listed under [WalletGuide](https://walletguide.walletconnect.network/?utm_source=walletconnect-docs&utm_medium=cloud&utm_campaign=explorer-submission) and [Cloud WalletGuide API](./explorer.md).
</Note>
...
- Go to the "WalletGuide" tab and fill in the details of your project.
...
|------------------------------|-------------------------------------------------------------------------------------------------------------------------|----------|
| **Name**                     | The name to display in the WalletGuide                                                                                    | Yes      |
...
| **Logo**                     | The logo of your project. Further requirements are provided in the WalletGuide submission form                            | Yes      |
...
Now depending on whether or not your submission met all parameters, you will receive an email from the Reown team with the status of your submission. This change will also be reflected with more directions in the "WalletGuide" tab of your project.
