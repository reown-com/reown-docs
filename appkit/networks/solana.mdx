...
The AppKit SDK supports Solana and SVM-based chains, allowing users to connect their wallets to applications built on Solana and compatible networks such as [Solayer InfiniSVM](https://solayer.org).
<Frame>
<video
  controls
