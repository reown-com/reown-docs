...
-   **EVM (Wagmi):**
    ```bash
    # For Expo
    npx expo install @reown/appkit-wagmi-react-native wagmi@2.18.0 viem@2.x @tanstack/react-query
    # For RN CLI
    # npm install @reown/appkit-wagmi-react-native wagmi@2.18.0 viem@2.x @tanstack/react-query
    # yarn add @reown/appkit-wagmi-react-native wagmi@2.18.0 viem@2.x @tanstack/react-query
    ```
-   **Solana:**
    ```bash
    # For Expo
