...
1. **Enable SIWX in your Reown AppKit configuration** - One-Click Auth requires [SIWX (Sign In With X)](./siwx) to be enabled in your Reown AppKit setup.

2. **Configure EVM chains only** - One-Click Auth currently supports EVM chains only. Make sure your Reown [networks](./options#networks) configuration includes only EVM-compatible chains.
