...
<Note>
This hook requires the `debug` option to be set to `true` in your Reown configuration to capture logs. See the [Options](/appkit/react-native/core/options#debug) documentation for more details.
</Note>
