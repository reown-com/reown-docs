...
The provider access hook that provides access to the underlying chain-specific provider for the currently active connection. Use this hook when you need to perform direct interactions with the blockchain that go beyond the standard Reown actions.
...
- Performing advanced blockchain operations not covered by Reown's standard actions
...
The logging hook that provides access to Reown's internal logging system. Use this hook when you need to debug your application, monitor Reown's behavior, or export logs for troubleshooting purposes.
...
### Use Cases
- Debugging Reown behavior and troubleshooting issues
