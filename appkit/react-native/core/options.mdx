...
*   **Description:** Sets the initial theme for the modal. Defaults to the system theme or 'light' if system theme is unavailable.
...
*   **Description:** Allows you to customize the accent color of the modal. Refer to the Theming documentation for details.
