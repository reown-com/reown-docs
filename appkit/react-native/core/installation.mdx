...
<Note>
**React Native New Architecture:** If your project has React Native's new architecture enabled, you need to provide a custom storage implementation to the coinbase connector:
...
You can detect if new architecture is enabled by checking: `(global as any)?.nativeFabricUIManager != null`
</Note>
