...
Get started quickly with our dedicated CLI that sets up a minimal Reown configuration for you.
...
Reown supports various custom connectors for specific wallets that use their own connection protocols. These connectors allow you to integrate popular wallets like Coinbase and Phantom directly into your Reown configuration.

### Coinbase

Coinbase Wallet is a popular wallet that uses a custom connection protocol. To enable it in your Reown configuration, you'll need to install the Coinbase SDK and add a specific connector.
...
Phantom and Solflare are popular wallets on the Solana blockchain. Because they use a custom connection protocol, it requires a specific connector to be added to your Reown configuration.
