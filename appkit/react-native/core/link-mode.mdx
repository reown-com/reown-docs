...
To support link mode add a universal link for your dapp in [Reown Dashboard](https://dashboard.reown.com) project configuration, configure your Metadata with a **valid universal link** and set the `linkMode` property to `true`:
