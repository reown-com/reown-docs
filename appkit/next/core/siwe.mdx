...
Install the Reown SIWE package. For the best experience, we recommend also installing [siwe](https://docs.login.xyz/) to abstract a lot of the required logic.
...
With help of the [siwe package](https://docs.login.xyz/sign-in-with-ethereum/quickstart-guide/implement-the-frontend) we will create the required configuration for Reown AppKit.
...
## Initialize Reown AppKit with your `siweConfig`.
