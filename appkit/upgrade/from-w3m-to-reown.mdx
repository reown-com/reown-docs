...
This guide is designed to help existing Reown customers better understand the latest version of the Reown SDK, and **complete the upgrade in less than 30 minutes**. We’ll walk you through the new features and benefits you can expect, along with clear, step-by-step instructions to help you seamlessly update your app to the latest version of Reown.

**Already good to go? [Upgrade to the latest version of Reown here.](#upgrade-platform-list)**
