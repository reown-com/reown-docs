...
The singleton instance access for Web3Modal has been replaced with Reown. Update all instances where Web3Modal.instance is used to Reown.instance.
...
The configure method has also been updated to reflect the new branding. Replace calls to Web3Modal.configure with Reown.configure. Old Configuration:
...
After updating all references to Web3Modal to use Reown, thoroughly test your application to ensure that all functionalities work as expected.
