---
title: WalletConnect Modal to AppKit Core
---

**AppKit Core is the upgraded version of WalletConnect Modal.** It provides a user-friendly experience while maintaining the familiar QR code functionality for wallet connections. **AppKit Core** is the base version of Reown that includes the traditional WalletConnect Modal with QR code functionality.

<Note>This is a preview version of AppKit Core.</Note>
 ...
 **AppKit Core** is the most basic version of Reown which replaces WalletConnect Modal. Please refer to [this section](#setting-up-appkit-core-from-scratch) if you are starting from scratch.

## Installation

You first need to install the Reown AppKit package in order to get started. You can do this by running the command below.
