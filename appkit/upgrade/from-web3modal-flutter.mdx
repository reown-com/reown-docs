...
### Step 2. Update your Reown's theme related classes
...
- Check our [Reown example for Flutter](https://github.com/reown-com/reown_flutter/tree/master/packages/reown_appkit/example/modal/lib) to compare with your implementation in case you are having issues
