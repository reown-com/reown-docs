...
<Steps>
    ...
    <Step title="Unlimited projects" icon="rectangle-history">
        Build, test, and scale without limits. Create and manage unlimited Reown projects under one account.
    </Step>
    ...
    <Step title="New feature beta program" icon="vial">
        Get early access to upcoming Reown features and shape the roadmap with feedback.
    </Step>
</Steps>
