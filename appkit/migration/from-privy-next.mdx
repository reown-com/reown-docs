...
You can check out our [examples](https://github.com/reown-com/appkit-web-examples) for a complete implementation using **Vite + Reown AppKit**.
</Note>
...
Replace Privy dependencies with Reown AppKit by running the following commands for your preferred package manager:
<CodeGroup>
...
2. Configure Reown AppKit Outside the Component
```tsx {1-11}
...
<Info>
Reown AppKit web components (like `<appkit-button>`) are **global HTML elements** — no imports are necessary. 
</Info>
