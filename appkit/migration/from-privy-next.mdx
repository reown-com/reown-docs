...
```bash npm
npm install @reown/appkit @reown/appkit-adapter-wagmi wagmi@2.18.0 viem && npm uninstall @privy-io/react-auth @privy-io/server-auth
```

```bash Yarn
yarn add @reown/appkit @reown/appkit-adapter-wagmi wagmi@2.18.0 viem && yarn remove @privy-io/react-auth @privy-io/server-auth
```

```bash Bun
bun a @reown/appkit @reown/appkit-adapter-wagmi wagmi@2.18.0 viem && bun remove @privy-io/react-auth @privy-io/server-auth
```

```bash pnpm
pnpm add @reown/appkit @reown/appkit-adapter-wagmi wagmi@2.18.0 viem && pnpm remove @privy-io/react-auth @privy-io/server-auth
```
</CodeGroup>
