...
Follow the steps below to migrate from the Starter Pack of Anza Adapter to Reown. Based on the default implementation. Our starting point is the [Anza Adapter Starter Pack](https://github.com/anza-xyz/wallet-adapter/blob/master/packages/starter/react-ui-starter/) in Github.
...
<Note>
Reown's web components are global HTML elements that don't require importing.
</Note>
...
After integrating Reown, you can interact with the Solana network using the `@solana/web3.js` library.
