...
- Run this command to install Reown AppKit and uninstall RainbowKit.
<CodeGroup>
```bash npm
...
Use the Reown AppKit Button. It can be configured following these [guidelines](https://docs.walletconnect.com/appkit/react-native/core/components#w3mbutton-).
