...
**SIWX** works as a plugin system for Reown and you are going to add the plugin in the Reown configuration. There are some ways to implement the **SIWX** feature:

- Use Reown Authentication to manage the sessions in the Reown Dashboard
- Use the `DefaultSIWX` class provided by Reown
