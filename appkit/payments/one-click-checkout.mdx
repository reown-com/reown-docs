...
**One-Click Checkout** enables lightning-fast crypto payments with just **one tap**; no manual wallet connections, no network switching, and no guesswork.

<Frame caption="One-Click Checkout Demo">
    <video
        autoPlay
        loop
        controls
