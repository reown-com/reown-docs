...
**Pay with Exchange** unlocks a powerful new flow: users can pay in crypto directly from their **Centralized Exchange (CEX) accounts** like Binance or Coinbase, **with no new wallets, no app switching, and no lost conversions.** This flow is bundled together with the **Pay with Self-Custodial Wallets** flow.

<Warning>
    Coinbase is currently not available in the Pay with Exchange flow. Further information will be available soon.
</Warning>
...
Want to see Pay with Exchange in action? Try out the live demo to experience Reown's Pay with Exchange flow firsthand. 
...
Currently, Pay with Exchange and Self-Custodial Wallets supports the following assets on the following networks:
...
<CardGroup cols={2}>
  <Card title="React" icon="react" href="/appkit/react/payments/pay-with-exchange">
    Get started with Pay with Exchange and self-custodial wallets in React.
  </Card>
  ...
  >
    Get started with Pay with Exchange and self-custodial wallets in Next.js.
  </Card>
  ...
  >
    Get started with Pay with Exchange and self-custodial wallets in Vue.
  </Card>

  <Card title="JavaScript" icon="js" href="/appkit/javascript/payments/pay-with-exchange">
    Get started with Pay with Exchange and self-custodial wallets in JavaScript.
  </Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="What UX do users see inside the exchange? Is it branded or generic?">
    Once redirected to the exchange, the user sees the **native exchange UI**. The SDK does **not inject branding or control the in-exchange experience**, ensuring a secure, familiar flow for the user and no compromise on exchange login or withdrawal authentication.
  </Accordion>
  ...
  <Accordion title="What happens if a payment fails on the CEX side?">
    ...
    - **The SDK does not emit a confirmation**, so apps can assume the transaction was not completed.
  ...
  <Accordion title="Can we monitor transactions in real time?">
    Yes. Reown provides **blockchain** **transaction IDs** upon payment confirmation, which can be used for real-time monitoring and reconciliation.
  </Accordion>
  </AccordionGroup>
  ...
  <Accordion title="How do we integrate this into our checkout or app flow?">
    Pay with Exchange is part of Reown Payments, it is available as a modal and a headless flow.
  </Accordion>

  <Accordion title="How long does a full integration typically take?">
    For developers already using Reown, integration is estimated to take **less than a day**. New customers must first complete the Reown SDK integration, which typically takes a few days depending on team setup.
  </Accordion>
  ...
  <Accordion title="Are there overage fees or API rate limits?">
    Yes, if usage exceeds Reown tier limits.
  </Accordion>
...
<AccordionGroup>
  ...
  <AccordionGroup>
  <Accordion title="Can we monitor transactions in real time?">
    Yes. Reown provides **blockchain** **transaction IDs**, which can be used for real-time monitoring and reconciliation.
  </Accordion>
  </AccordionGroup>
  ### Integration & Support
  ...
  <AccordionGroup>
  <Accordion title="How do we integrate this into our checkout or app flow?">
    Pay with Wallet is part of **Reown Payments**, which includes components to handle wallet connection, transaction creation, and monitoring. Integration follows the standard Reown SDK setup and works as a modal.
  </Accordion>
