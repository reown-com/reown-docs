...
guide on custom crafting your policy](../../cloud/paymaster). However, for
...
<Frame>
![](/images/paymasters/rpc-urls.png)
</Frame>
...
### Step 2: Calculate CallData and Prep transaction
```ts
...
### Step 3: Import `sendCalls` from Wagmi
```ts
...
### Step 4: Add Event Handler to a button
```ts
