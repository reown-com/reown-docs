---
title: Update Reown packages to the latest
---
...
<Note>
More @reown/* packages can be used in your project. This is an example of a project using Reown and Wagmi for EVM networks.
</Note>

## 1. Find the latest Reown version
...
<Note>
Reown publishes its packages in coordinated releases; mixing versions can cause subtle peer-dep and type mismatches, so keep @reown/* on the exact same X.Y.Z. 
</Note>
...
That’s it. This keeps your Reown stack consistent and aligned with the latest release.

All the releases information are available in the [Reown GitHub Releases](https://github.com/reown-com/appkit/releases).