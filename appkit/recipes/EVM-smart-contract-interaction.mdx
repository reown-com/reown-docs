---
title: "How to Interact with EVM Smart Contracts using Reown and React"
...
## Final project
<Card title="Reown Wagmi Example with smart contract interactions" icon="github" href="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-wagmi">
Download the full project to try it directly on your computer.
</Card>

<Card title="Reown Ethers Example with smart contract interactions" icon="github" href="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-ethers">
Download the full project to try it directly on your computer.
</Card>
...
2. Call the Reown Provider hook:
...
By following this guide, you've learned how to integrate Reown with Wagmi or Ethers to interact with a smart contract.
