---
title: "How to use Smart Session with React"
sidebarTitle: "Smart Sessions using AppKit"
---
Learn how to use Reown AppKit with Smart Sessions to grant permissions to delegate actions for a period of time.
...
This is the completed working example to use and understand how smart sessions work with AppKit.
