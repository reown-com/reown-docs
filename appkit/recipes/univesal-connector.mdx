---
title: "Use Universal Connector for WalletConnect QR Code"
...
<img src="/images/assets/walletconnectQR.jpg" />
...
## Final project
<Card title="WalletConnet SDK with QR Code" icon="github" href="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-core-universal-connector">
Download the full project to try it directly on your computer the use of Univesal Connector.
</Card>
...
In order to setup the project, you need to install the following packages:
...
You can configure with the networks you want to support. For more information, please visit please visit [RPC Reference](https://docs.reown.com/advanced/multichain/rpc-reference/cosmos-rpc) section from our docs.
