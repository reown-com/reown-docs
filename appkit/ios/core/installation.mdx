...
You can add Reown to your project with Swift Package Manager. In order to do that:

1. Open Xcode
2. Go to File -> Add Packages
3. Paste the repo GitHub url: https://github.com/reown-com/reown-swift
4. Tap Add Package
5. Choose the Reown products that you want installed in your app.

### Alternatively, add Reown to a `Package.swift` manifest

To integrate via a `Package.swift` manifest instead of Xcode, you can add
Reown to the dependencies array of your package:
...
Then, in any target that depends on a Reown product, add it to the `dependencies`
...
<Card
  title="Reown with Swift example"
  icon="github"
