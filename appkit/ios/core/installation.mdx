...
You can add Reown AppKit to your project with Swift Package Manager. In order to do that:
...
### Alternatively, add Reown AppKit to a `Package.swift` manifest

To integrate via a `Package.swift` manifest instead of Xcode, you can add
Reown AppKit to the dependencies array of your package:
...
Want to see Reown in action? Download our sample apps below and explore what it can do. Enjoy! 😊
