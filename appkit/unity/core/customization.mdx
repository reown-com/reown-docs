...
All screens in the modal (e.g. Account, Wallet Search, QR Code, etc.) are called `modal view`. The class that
...
All core views accept optional path to the UXML layout file in the constructor.
