...
To interact with EVM chains use `AppKit.Evm` (see [Actions](/appkit/unity/core/actions#evm-actions) for more details). Internally, Reown will use Wagmi on WebGL or Nethereum on other platforms.
...
After completing [Reown installation](/appkit/unity/core/installation), add Solana chain to your Reown configuration and use `AppKit.Solana`.
