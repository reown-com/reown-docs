...
Note: The chain must be added to the list of [supported chains in the Reown AppKit configuration](https://docs.reown.com/appkit/unity/core/options#supported-chains).
