...
<Card title="Svelte" icon="/images/icons/svelte.svg" href="./svelte/core/installation">
  Get started with Reown in Svelte.
</Card>

<Card title="Nuxt" icon="mountains" href="./nuxt/core/installation">
  Get started with Reown in Nuxt.
</Card>
...
Simplify token swapping for users with Reown Modal, allowing secure, in-app swaps with just one line of code.
