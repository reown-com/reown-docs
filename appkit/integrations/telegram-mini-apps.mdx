...
If you are building Web3 mini-app on telegram, Reown provides the perfect out of the box interface for your users to connect their self-custodial Wallet or create their first wallet using Email or Social login.
...
<Info>
  ...
  profile, then click the "Open App" button. This will open Reown Lab, allowing
