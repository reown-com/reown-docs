...
<AccordionGroup>
  <Accordion title="Why am I seeing an 'Invalid App Configuration' error?">
    ...
    2. Add it to your Reown AppKit configuration:
  ...
  <Accordion title="How can I use custom RPCs with Reown?">
    You can use your own RPC by setting the `customRpcUrls` option in the Reown AppKit configuration. This lets you define custom RPC URLs for specific chains. Each entry must follow the format:
    ...
    The SDK will prioritize these URLs over the default ones.
  </Accordion>
</AccordionGroup>
