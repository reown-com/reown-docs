...
<Accordion title="How do I remove the 'UX by Reown' branding?">
  ...
  <Accordion title="Is there a limit on self-custodial wallet connections?">
    There is no fixed number for what counts as "excessive" self-custodial connections. Our Terms of Service reserve the right to limit usage that is clearly abusive or disruptive, such as traffic spikes or automated spamming, and this is assessed case by case. See our [Community Licence](https://github.com/reown-com/appkit-react-native?tab=License-1-ov-file#readme) for the clearest thresholds before paid plans are needed:
    ...
    **Using your own RPC provider?** The RPC threshold above does not apply to you. The only limit that could apply is the general fair-use clause in our ToS. If your usage could reasonably be described as a spike attack or sustained automated abuse, that is when it becomes a concern. Normal app traffic is not what this clause is designed for.
  </Accordion>
</AccordionGroup>
