...
<Accordion title="How do I remove the 'UX by Reown' branding?">
  ...
  <Accordion title="Is there a limit on self-custodial wallet connections?">
    There is no fixed number for what counts as "excessive" self-custodial connections. Our Terms of Service reserve the right to limit usage that is clearly abusive or disruptive, such as traffic spikes or automated spamming, and this is assessed case by case. See our Community Licence for the clearest thresholds before paid plans are needed:
