...
### 1. Built-in within Reown (No extra code required)

After enabling the feature, it's automatically available within the modal. Users can access it by:

1. Connecting their wallet through Reown
