...
1. Be sure to have this properly configured on your server (`.well-known/apple-app-site-association` and `.well-known/assetlinks.json`) and native app side.

    - If your domain is `https://example.com/` you should have your configuration files under
      - https://example.com/.well-known/apple-app-site-association
      - https://example.com/.well-known/assetlinks.json
    - See more about this on [Platform Specific](#platform-specifics) section
