...
Reown AppKit's metadata object contains a `redirect` option that should be used by the wallet to redirect back to your dapp after connection.
...
If you'd like, you can also override Reown AppKit's buttons by using the `custom:` property as follows
