...
Furthermore, Phantom Wallet's deep/universal linking mechanism supports interaction exclusively with the Solana network. This means that if you have EVM networks configured in your Reown instance, they will not be available for use after connecting with Phantom.
...
Furthermore, Solflare Wallet's deep/universal linking mechanism supports interaction exclusively with the Solana network. This means that if you have EVM networks configured in your Reown instance, they will not be available for use after connecting with Solflare.
