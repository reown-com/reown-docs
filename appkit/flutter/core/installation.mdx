...
<Note>
Apple only allows 50 entries top in this array, so every other entry beyond the 50th it won't be considered. See note here: https://developer.apple.com/documentation/uikit/uiapplication/canopenurl(_:)#Discussion
</Note>
