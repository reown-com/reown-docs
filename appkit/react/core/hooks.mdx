...
<Note>
  Multi-wallet functionality must be enabled in your Reown configuration. This feature requires a Pro or Enterprise plan and must be activated in your Reown Cloud dashboard.
</Note>
