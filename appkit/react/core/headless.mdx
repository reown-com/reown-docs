...
<Note>
  Headless must be enabled via the dashboard under the **Customization** section. See the [dashboard configuration settings](/cloud/dashboard-configuration-settings#headless) for details.
</Note>
