...
Headless allows developers to build a fully customizable "Connect" experience powered by Reown's existing features without using the modal. Headless exposes wallet discovery, rendering WalletConnect QR codes, and social provider flows via simple hooks and utility functions.
