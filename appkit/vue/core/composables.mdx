...
- `stateData.initialized`: Boolean that indicates if the AppKit has been initialized. This sets to true when all controllers, adapters and internal state is ready
- `stateData.loading`: Boolean that indicates if the AppKit is loading
