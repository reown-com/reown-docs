...
You can use your own RPC by setting the `customRpcUrls` option in the [Reown AppKit configuration](/appkit/react/core/options#customrpcurls). This lets you define custom RPC URLs for specific chains. Each entry must follow the format:
