...
**Setting up from scratch? Try installing [AppKit Skills](#appkit-skills) to get AI-assisted guidance, or use the [AppKit CLI templates](#alternative-installation).**
