...
To open Reown you can use our [**web components**](/appkit/vue/core/components) or build your own button with Reown [**composables**](/appkit/vue/core/composables#useAppKit).
