...
<CardGroup cols={2}>
  ...
  <Card title="Flutter" icon="flutter" href="/walletkit/flutter/early-access/chain-abstraction">
  ...
  <Card title="Web" icon="js" href="/walletkit/web/early-access/chain-abstraction">
