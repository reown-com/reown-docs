...
For instance, if your Wallet's name is Example Wallet, your custom scheme would be more likely as `examplewallet://`, therefore you will add the following in your iOS's Info.plist file:
...
For instance, if your Wallet's name is Example Wallet, your custom scheme would be more likely as `examplewallet://`, therefore you will add the following intent filter in your Android's Manifest.xml file:
