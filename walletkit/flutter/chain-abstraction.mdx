...
You can also use the [AppKit laboratory](https://appkit-lab.reown.com/appkit/?name=wagmi) and try sending [USDC/USDT](#what-are-the-supported-tokens-and-networks) with any chain abstraction-supported wallet. 
