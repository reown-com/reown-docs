...
sidebarTitle: "Solana / SVM Adapter"
---
...
This adapter is compatible with **Solana and SVM-based chains**, including [Solayer InfiniSVM](https://solayer.org). Applications built on SVM-compatible networks can use the same Solana adapter for wallet authentication and transaction signing.
