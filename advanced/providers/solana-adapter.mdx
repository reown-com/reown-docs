...
<Info>
  ...
  instead](../../appkit//overview). Reown now supports multichain, which means you can choose and
  configure multiple blockchain networks within your instance of Reown, extending beyond just
