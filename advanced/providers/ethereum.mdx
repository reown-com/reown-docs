...
<Note>
`showQrModal` has been deprecated as WalletConnect's Web3Modal is now rebranded as Reown. If you are looking to use this, please refer to the ["**Use with Reown**"](#use-with-appkit) section below.
</Note>
...
The QRModal is enabled by default on Reown. In order to use it, all you need to do is to create a Reown AppKit instance.
