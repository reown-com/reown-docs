...
The Push Server sends WalletConnect protocol activity using FCM or APNs to users. The Push Server can be used with the WalletConnect [Wallet SDK](https://docs.walletconnect.network/wallet-sdk/overview).
