...
One can find the following methods in action in Reown's [Advanced Web Examples](https://github.com/reown-com/web-examples), as they have already been integrated there.

- [React Wallet v2](https://github.com/reown-com/web-examples/tree/main/advanced/wallets/react-wallet-v2) ([Demo](https://react-wallet.walletconnect.com/))
- [React dApp v2](https://github.com/reown-com/web-examples/tree/main/advanced/dapps/react-dapp-v2) ([Demo](https://react-app.walletconnect.com/))
