...
| CAIP-2 / CAIP-25 Chain ID | Chain ID | Name | RPC Endpoint | Namespace |
|---------------------------|----------|------|--------------|-----------|
...
Additionally, the WalletConnect RPC proxy may be used:

```
https://rpc.walletconnect.org/v1?chainId=ton:<chainId>&projectId=<PROJECT_ID>
```
