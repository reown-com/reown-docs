...
- `@walletconnect/web3wallet` deprecated in favor of `@reown/walletkit`
  ...
  - For guidance on how to update your existing `@web3modal/*` implementation, please see the [Reown migration guide](/appkit/upgrade/to-reown-appkit-web).
...
For guidance on how to update your implementation, please see [React Native Reown migration guide](https://docs.walletconnect.network/wallet-sdk/upgrade/from-web3wallet-react-native)
...
For guidance on how to update your Unity packages, please see the [Web3Modal to Reown migration guide](/appkit/upgrade/from-web3modal-unity)
