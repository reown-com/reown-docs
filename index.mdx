...
<CardGroup cols={3}>
  <Card title="Installation guides" icon="code" href="/appkit/overview#get-started-with-your-chosen-framework">
    Configure a full Reown SDK installation
  </Card>

  <Card title="AI Assistance" icon="robot" href="/appkit/overview#get-started-with-ai-assistance">
    Get started with our AI Skills
  </Card>

  <Card title="Start with the CLI" icon="terminal" href="/appkit/overview#get-started-with-the-cli">
    Use the CLI with our working templates
  </Card>
</CardGroup>
## About Reown SDK
