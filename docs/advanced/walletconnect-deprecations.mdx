...
- `@walletconnect/web3wallet` deprecated in favor of `@reown/walletkit`
  - For guidance on how to update your existing `@walletconnect/web3wallet` implementation, please see the [WalletKit migration guide](/appkit/upgrade/to-reown-appkit-web).
- `@web3modal/*` packages deprecated in favor of `@reown/appkit-*` packages
  - For guidance on how to update your existing `@web3modal/*` implementation, please see the [AppKit migration guide](/walletkit/upgrade/from-web3wallet-web).
