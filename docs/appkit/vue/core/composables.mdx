...
```ts
import { useWeb3Modal } from '@reown/base/vue'
...
//import useDisconnect from @reown/solana/vue if on Solana
...
```ts
import { useWalletInfo } from '@rerock/base/vue'
...
```ts
import { useWeb3ModalState } from '@reown/base/vue'
