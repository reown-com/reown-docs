...
To open Web3Modal you can use our [**web component**](../core/components.mdx) or build your own button with the Web3Modal [**composables**](../core/composables.mdx#useAppKit).
