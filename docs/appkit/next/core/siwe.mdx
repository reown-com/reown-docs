...
<GithubBox name="Next.js SIWE Example" url="https://github.com/reown-com/appkit-web-examples/tree/main/nextjs/next-siwe-next-auth" description="Check the Next.js example using NextAuth"></GithubBox>
