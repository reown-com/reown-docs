...
```bash npm2yarn
npm i @reown/siwe siwe next-auth
```
...
import type { SIWEVerifyMessageArgs, SIWECreateMessageArgs, SIWESession } from '@reown/siwe'
import { createSIWEConfig, formatMessage } from '@reown/siwe'
import { mainnet, sepolia } from 'reown/base/chains'
...
```ts
import { verifySignature } from '@reown/siwe'
...
```ts
import {getChainIdFromMessage} from '@reown/siwe'
...
```ts
import { getAddressFromMessage } from '@reown/siwe'
...
import type { SIWEVerifyMessageArgs, SIWECreateMessageArgs } from '@reown/siwe'
import { createSIWEConfig, formatMessage } from '@reown/siwe'
...
import type { SIWESession } from '@reown/siwe'
import { SiweMessage } from 'siwe'
...
```js
// Pass your siweConfig inside the createWeb3Modal() function
