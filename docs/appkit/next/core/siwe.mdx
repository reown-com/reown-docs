...
<GithubBox name="Next.js SIWE Example" url="https://github.com/reown-com/web-examples/tree/main/dapps/appkit-siwe/next" description="Check the Next.js example using NextAuth"></GithubBox>
