...
- Check our [AppKit web examples](https://github.com/WalletConnect/web-examples/tree/main/dapps/web3modal/react-solana) to compare with your implementation in case you are having issues. Also 
