...
:::important
When you upgrade, please make sure that you remove the `@walletconnect/modal` package from your project. Ensure that this is also removed from your `package.json` file.
:::
