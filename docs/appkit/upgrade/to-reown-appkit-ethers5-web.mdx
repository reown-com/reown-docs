...
## AppKit v5 to Reown Web AppKit | Ethers v5

This guide will help you migrate from AppKit v5 using ethers v5 to the latest Reown AppKit.
...
To upgrade from AppKit v5 to Reown AppKit start by removing AppKit v5 dependencies `@web3modal/ethers5`. 
...
Finally, create the `Ethers5Adapter` and pass the other parameters to `createAppKit`
...
Finally, create the `Ethers5Adapter` and pass other parameters to `createAppKit`.
