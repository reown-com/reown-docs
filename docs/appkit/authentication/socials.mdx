...
We partner with Magic.link to provide Universal Wallets, for information on how these are created and how the Private Keys are managed go [here](https://magic.link/docs/home/security/product-security#patented-key-management)
