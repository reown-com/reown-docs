...
<GithubBox name="React SIWE Example" url="https://github.com/reown-com/web-examples/tree/main/dapps/appkit-siwe/react" description="Check the client/server React example"></GithubBox>
