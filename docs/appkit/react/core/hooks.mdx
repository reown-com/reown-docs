...
```ts
import { useWeb3Modal } from '@reown/base/react'
...
//import useDisconnect from @reown/solana/react if on Solana
...
```ts
import { useWalletInfo } from '@reown/base/react'
...
```ts
import { useWeb3ModalState } from '@reown/base/react'
...
```ts
import { useWeb3ModalTheme } from '@reown/base/react'
...
```ts
import { useWeb3ModalEvents } from '@reown/base/react'
