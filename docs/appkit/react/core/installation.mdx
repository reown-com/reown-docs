...
```bash npm2yarn
npm install @reown/appkit-adapter-ethers5 ethers@5.7.2
```
...
```bash npm2yarn
npm install @reown/appkit-adapter-ethers ethers
```
...
```tsx
import { useWeb3ModalProvider, useWeb3ModalAccount } from "@reown/appkit/react";
