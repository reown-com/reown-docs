...
<Table
  ...
  data={[
    ...
    {
      variable: { code: 'namespace' },
      description: 'Option to show specific namespace account info. Note: `eip155` is for EVM and `bip122` is for Bitcoin.',
      type: { code: "'eip155' | 'solana' | 'bip122'" }
    }
  ]}
/>
