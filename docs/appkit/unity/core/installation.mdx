...
<GithubBox name="Unity AppKit Example" url="https://github.com/reown-com/reown-dotnet/tree/main/sample/Reown.AppKit.Unity" description="Check the Unity example into Github"></GithubBox>

- webGL sample:  https://unity-appkit.vercel.app/

- Firebase AppKit: https://appdistribution.firebase.dev/i/093025eda71719e2

- Apple Testflight in Unity: https://testflight.apple.com/join/MPkPYk43