---
title: Send a Solana Transaction Using AppKit Web
---
...
## Final project
<GithubBox name="Appkit Example for Interacting with the Solana Blockchain" url="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-solana" description="Clone this Github repo to try it out locally."></GithubBox>
