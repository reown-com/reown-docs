...
<GithubBox name="Travel Rule SIWX Example" url="https://github.com/reown-com/appkit-web-examples/tree/main/nextjs/next-siwx-multichain" description="Check out this example implementation of Travel Rule compliance using SIWX with multichain"></GithubBox>
...
For more advanced customization options, refer to our [SIWX documentation](/appkit/features/siwx/default)
