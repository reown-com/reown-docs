...
## Final project
<GithubBox name="Appkit wagmi Example with blockchain interactions" url="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-wagmi" description="Download the full project to try directly in your computer"></GithubBox>


## AppKit Minimal Installation

You can start an small project following the guidelines from our [installation React docs using Wagmi](https://docs.reown.com/appkit/react/core/installation?platform=wagmi)
