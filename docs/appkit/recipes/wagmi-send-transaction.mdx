...
## Final project
<GithubBox name="Appkit wagmi Example with blockchain interactions" url="https://github.com/reown-com/web-examples/tree/main/dapps/appkit/react-wagmi" description="Download the full project to try directly in your computer"></GithubBox>
