...
<GithubBox name="AppKit EVM Example" url="https://github.com/rohit-710/reown-appkit-evm" description="Check out the complete AppKit example on this Github repo."></GithubBox>
