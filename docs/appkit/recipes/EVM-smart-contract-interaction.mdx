---
title: Interacting with EVM Smart Contracts Using AppKit
...
## Final project
<GithubBox name="Appkit Wagmi Example with smart contract interactions" url="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-wagmi" description="Download the full project to try it directly on your computer."></GithubBox>
<GithubBox name="Appkit Ethers Example with smart contract interactions" url="https://github.com/reown-com/appkit-web-examples/tree/main/react/react-ethers" description="Download the full project to try it directly on your computer."></GithubBox>
...
To interact with the smart contract you will need to have some tokens in order to pay for the gas fees to write into the contract. You can get them from this [faucet](https://cloud.google.com/application/web3/faucet/ethereum/sepolia), but also you can search for other options in the web.
Also is good to know that reading from a smart contract is free.

For both SDKs, you will need to declare the contract address and ABI.
