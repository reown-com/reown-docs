...
A list of all available methods can be found in [constants.dart](https://github.com/WalletConnect/ReownFlutterV2/blob/master/lib/apis/utils/constants.dart#L70) file, which is already exported for you to use directly from web3modal package.
