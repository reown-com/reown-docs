...
In order to fully works, Link Mode requires you to enable also [One-Click Auth + Sign In With Ethereum](./siwe.mdx) feature.
...
Check out [SIWE basic example](./siwe.mdx#basica-usage-example) to try it out.
:::
