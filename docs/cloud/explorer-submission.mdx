...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      steps: `1. Open the WalletConnect connection page http://appkit-lab.reown.com/ or https://react-app.walletconnect.com/ from a PC
    ...
    },
    {
      ...
      steps: `1. Open http://appkit-lab.reown.com/ in your mobile device.
  ...
  data={[
    {
      ...
      steps: `1. Connect the wallet to http://appkit-lab.reown.com/library/solana
              2. Press the “Sign Message” button.
              3. Accept the signature request on the wallet.`,
      expectedResults: `1. N/A
                        2. A modal should popup on the wallet app requesting for a signature.
