...
### Domain risk detection[](https://docs.rewon.com/walletkit/web/verify#domain-risk-detection)
...
<PlatformTabs activeOptions={["ios","android", "flutter", "react-native"]}>
  ...
  <PlatformTabItem value="flutter" label="Flutter">
  - **ReownFlutterV2**: [Latest release](https://github.com/WalletConnect/ReownFlutterV2/releases/latest)
  </PlatformTabItem>
