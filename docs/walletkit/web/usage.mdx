...
:::note
Make sure you initialise `walletKit` globally and use same instance for all your sessions. For React based apps, you can initialise it in root component and export it to use in other components.
:::
