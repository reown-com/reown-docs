...
:::caution
Link Mode is currently in **Beta** for Flutter. You should install [v2.4.0-beta01](https://pub.dev/packages/reown_flutter_v2/versions/2.4.0-beta01) to try it out
:::
...
You can check our Flutter Sample Wallet's [AppDelegate file](https://github.com/WalletConnect/ReownFlutterV2/blob/develop/example/wallet/ios/Runner/AppDelegate.swift) as a reference.
...
You can check out tge Flutter Sample Wallet's [MainActivity file](https://github.com/WalletConnect/ReownFlutterV2/blob/develop/example/wallet/android/app/src/main/kotlin/com/example/wallet/MainActivity.kt) as a reference.
