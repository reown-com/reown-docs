...
You can use [AppKit Labs](http://appkit-lab.reown.com/library/ethers-siwe/) to test and verify that your wallet supports One-click Auth properly.

<Button name="Test One-click Auth" url="http://appkit-lab.reown.com/library/ethers-siwe/" />
