...
description: Write and review documentation for Reown products using Mintlify. Use when writing docs for Reown, AppKit, WalletKit, creating SDK guides, writing overview pages, reviewing documentation, or when the user mentions Reown docs, documentation, Mintlify, or technical writing.
---
...
| Reown AppKit API Reference v2.0 | API Reference |
...
sequenceDiagram
    ...
    AppKit->>Wallet: Connection Request
    Wallet->>User: Approve Connection
    User->>Wallet: Confirm
    Wallet->>AppKit: Connected
    AppKit->>dApp: Session Established
```
